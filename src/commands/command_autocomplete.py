...
CMD_LIST: list[BotCommand] = [
    ...
    BotCommand("set_payment_director", "Set payment director"),
    BotCommand("set_bot_director", "Set bot director"),
    BotCommand("set_location", "Set location for sessions"),
    BotCommand("set_cost", "Set cost for all sessions"),
